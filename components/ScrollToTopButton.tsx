...
const ScrollToTopButton: React.FC = () => {
  ...
  return (
    <button
      ref={buttonRef}
      onClick={scrollToTop}
      className="fixed bottom-8 right-28 z-[90] w-14 h-14 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-500 shadow-2xl transition-all hover:border-blue-500 hover:scale-110 active:scale-95 group hidden opacity-0 scale-50 translate-y-5"
