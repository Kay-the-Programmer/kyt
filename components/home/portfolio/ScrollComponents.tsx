...
export const PortfolioProgressBar = React.forwardRef<HTMLDivElement, {}>((props, ref) => {
    return (
        <div ref={ref} className="fixed bottom-0 left-0 h-1.5 w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 origin-left scale-x-0 z-[80] hidden lg:block opacity-60 shadow-[0_0_20px_rgba(59,130,246,0.5)]"></div>
    );
});
